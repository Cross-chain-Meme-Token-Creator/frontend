...
import { TokenCreatedSuccesfullyModal } from "./TokenCreatedSuccesfullyModal"
...
const WrappedCreateTokenForm = () => {
    ...
    return (
        <>
            <Card
                className="max-w-[500px] mx-auto mt-12 border border-divider"
                shadow="none"
            >
